                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            $disabled = ($reservation_start != $today) ? 'disabled' : ''; // Check condition and set the disabled attribute
                            ?>
                            <button name="reserv-checkin" data-id="<?php echo $r['reservation_id'] ?>" class="btn btn-sm m-1 bg-gradient-maroon" <?php echo $disabled; ?>>
